...
public class MainMultiplication extends AppCompatActivity {
    ...
    GameMultiply gameMul = new GameMultiply();
    ...
    CountDownTimer timer = new CountDownTimer(10000,1000) {
        ...
        public void onFinish() {
            ...
            scoreAlert(Integer.toString(gameMul.getScore()) + " points");
            tv_bottommessage.setText("Time is Up!!! " + gameMul.getNumberCorrect() + "/" + (gameMul.getTotalQuestions() - 1));
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gameMul.checkAnswer(answerSelected);
                //converted the integer into Strings
                tv_score.setText(Integer.toString(gameMul.getScore())); //to update the scores
    ...
    private void nextTurn() {
        ...
        gameMul.makeNewQuestion();
        int[] answer = gameMul.getCurrentQuestion().getAnswerArray();

        // set the QUESTION in the UI
        tv_questions.setText(gameMul.getCurrentQuestion().getQuestionPhrase());
        ...
        tv_bottommessage.setText(gameMul.getNumberCorrect() + "/" + (gameMul.getTotalQuestions() - 1)); //-1 because totalQuestions value comes when question appear
    }
    //Once the timeout the total score will be displayed through a dialog box as a popup
    private void scoreAlert(String message){
        AlertDialog alertDialog = new AlertDialog.Builder(MainMultiplication.this)
