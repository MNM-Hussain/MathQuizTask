...
public class MainDivision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gamediv.checkAnswer(answerSelected);
                //converted the integer into Strings
                tv_score.setText(Integer.toString(gamediv.getScore())); //to update the scores
    ...
    private void nextTurn() {
        ...
        gamediv.makeNewQuestion();
        int[] answer = gamediv.getCurrentQuestion().getAnswerArray();

        // set the QUESTION in the UI
        tv_questions.setText(gamediv.getCurrentQuestion().getQuestionPhrase());
        ...
        tv_bottommessage.setText(gamediv.getNumberCorrect() + "/" + (gamediv.getTotalQuestions() - 1)); //-1 because totalQuestions value comes when question appear

    }
    //Once the timeout the total score will be displayed through a dialog box as a popup
    private void scoreAlert(String message){
        AlertDialog alertDialog = new AlertDialog.Builder(MainDivision.this)
