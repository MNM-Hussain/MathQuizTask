...
//            //to view the total Score of the user once the game over through a dialog box
            ...
            tv_bottommessage.setText("Score Is " + gameadd.getNumberCorrect() + "/" + (gameadd.getTotalQuestions() - 1));
...
//        prog_timer.setProgress(0);
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                gameadd.checkAnswer(answerSelected);
    ...
    private void nextTurn(){
        ...
        gameadd.makeNewQuestion();
        int [] answer = gameadd.getCurrentQuestion().getAnswerArray();

        // set the QUESTION in the UI
        tv_questions.setText(gameadd.getCurrentQuestion().getQuestionPhrase());
